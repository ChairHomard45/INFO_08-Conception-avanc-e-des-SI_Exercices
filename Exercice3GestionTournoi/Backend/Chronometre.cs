...
namespace Exercice3GestionTournoi.Backend
{
    public class Chronometre
    {
        ...
        {
            NotificationTournoi notif = new NotificationTournoi { Type = NotificationTournoiType.UpdateChrono, tempsRestant = tempsRestant };
            Tournoi.Instance.updateTime(notif);
        }
